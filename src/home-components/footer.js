        ...
        <ul className="flex justify-center invisible md:visible space-x-2 text-sm p-2">
            ...
            <section className="bg-gray-200 md:grid grid-cols-2 gap-2 justify-start w-full md:p-6">
                ...
                <h2>Browse by Category</h2>
                    ...
                    <a href="" className="footerlink">AliExpress Assistant</a>
            ...
            <div className="col-span-1">
                ...
                <a href="" className="footerlink">AliExpress,</a>
                <a href="" className="footerlink">Alimama,</a>
                <a href="" className="footerlink">Alipay,</a>
                <a href="" className="footerlink">Fliggy,</a>
                <a href="" className="footerlink">Alibaba Cloud,</a>
                <a href="" className="footerlink">Alibaba International,</a>
                <a href="" className="footerlink">AliTelecom,</a>
                <a href="" className="footerlink">DingTalk,</a>
                ...
                <a href="" className="footerlink">AliOS,</a>
